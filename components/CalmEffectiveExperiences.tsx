// components/CalmEffectiveExperiences.tsx
'use client';
...
export default function CalmEffectiveExperiences() {
  return (
    <div className="w-full">
      <h2 className="text-xl font-bold text-gray-800 text-center mb-4">Most effective calm experiences</h2>
      <div className="flex flex-col lg:flex-row gap-8 justify-center">
        <ExperienceTable title="Most Effective Calm Experiences (Based on Organizational Analytics)" experiences={experienceData} />
        <ExperienceTable title="Most Effective Calm Experiences (Based on overall Liminal Analytics)" experiences={experienceData} />
      </div>
    </div>
  );
}
